...
<table class="wp-list-table widefat" id="rc-shortcode-table">
	<thead>
		<tr>
			...
			<th><?php esc_html_e('Shortcode', 'bestbug') ?></th>
	...
	<tbody>
		...
		?>
			<tr class="bb_scroll">
				...
				<td><?php echo esc_html($scene->post_name) ?></td>
				<td><strong><input style="width: 225px;" type="text" value='[bb_scrollmagic_scene id="<?php echo esc_html($scene->ID) ?>"]' disabled></strong></td>
